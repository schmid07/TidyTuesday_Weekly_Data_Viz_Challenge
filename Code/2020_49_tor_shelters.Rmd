...
See here for helpful tutorial on working with OSM: https://ggplot2tutor.com/streetmaps/streetmaps/
```{r getting maps}
...
plot_shelter <- ggplot(df_shelter_join) +
  ...
  labs(title = "{frame_time}",
       subtitle = "Toronto shelters: \n below & <b style='color:#E66100'>above capacity</b>",
